package de.gregorpoloczek.projectmaintainer.core.domain.workspace.config;
...
import de.gregorpoloczek.projectmaintainer.core.domain.encryption.service.EncryptionService;
